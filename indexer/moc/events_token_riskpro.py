...
class IndexRISKPROTransfer(BaseIndexEvent):
    ...
    def index_event(self, tx_event, token_involved='RISKPRO'):
    ...
    def index_events(self):
        ...
        filter_address = self.contract_MoC.sc_moc_bpro_token.address()
        ...
        for tx_event in self.tx_receipt.events:
            ...
            if self.name in tx_event:
                ...
                self.index_event(d_event.event, token_involved='RISKPRO')
