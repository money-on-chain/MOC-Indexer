...
docker tag moc_indexer_$ENV:latest $AWS_ID.dkr.ecr.$REGION.amazonaws.com/moc_indexer_$ENV:latest
docker push $AWS_ID.dkr.ecr.$REGION.amazonaws.com/moc_indexer_$ENV:latest
